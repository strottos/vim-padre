...
command -nargs=0 -count=1 PadreStepIn call padre#debugger#StepIn(<count>)
command -nargs=0 -count=1 PadreStepOver call padre#debugger#StepOver(<count>)
command -nargs=0 PadreStepOut call padre#debugger#StepOut()
