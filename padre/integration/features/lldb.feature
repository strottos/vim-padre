Feature: LLDB
    ...
    Scenario: Printing variables in rust
        ...
        When I send a request to PADRE 'print variable=a'
        Then I receive a response 'OK variable=a value="42" type="number"'
        When I send a request to PADRE 'stepOver'
        Then I receive both a response 'OK' and I expect to be called with
            | function                      | args                             |
            | padre#debugger#JumpToPosition | [".*test_print_variables.rs$",6] |
        When I send a request to PADRE 'print variable=b'
        Then I receive a response 'OK variable=b value="{\\"type\\":\\"int *\\","\\deref\\":\\"42\\"}" type=JSON'
        When I send a request to PADRE 'stepOver'
        Then I receive both a response 'OK' and I expect to be called with
            | function                      | args                             |
        ...
        When I send a request to PADRE 'print variable=a'
        Then I receive a response 'OK variable=a value=true type=boolean'
        When I send a request to PADRE 'stepOver'
        Then I receive both a response 'OK' and I expect to be called with
            | function                      | args                             |
            | padre#debugger#JumpToPosition | [".*test_print_variables.rs$",9] |
        When I send a request to PADRE 'print variable=a'
        Then I receive a response 'OK variable=a value="TEST" type=string'
        When I send a request to PADRE 'stepOver'
        Then I receive both a response 'OK' and I expect to be called with
            | function                      | args                              |
            | padre#debugger#JumpToPosition | [".*test_print_variables.rs$",10] |
        When I send a request to PADRE 'print variable=b'
        Then I receive a response 'OK variable=b value="TEST" type=string'
